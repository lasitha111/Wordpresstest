...
<?php $elixar_fields = array(
		'author' => '<label>' . esc_html__('Name', 'elixar') . '<span class="e-default-colored">*</span></label><div class="row mb-twenty"><div class="col-md-7 col-md-offset-0"><input type="text" class="form-control" value="" placeholder="' . esc_attr('Name (required)', 'elixar') . '" name="author" id="author"></div></div>',
		'email' => '<label>' . esc_html__('Email', 'elixar') . '<span class="e-default-colored">*</span></label><div class="row mb-twenty"><div class="col-md-7 col-md-offset-0"><input type="text" class="form-control" value="" placeholder="' . esc_attr('Email (required)', 'elixar') . '" name="email" id="email"></div></div>',
	);
	...
	$elixar_comments_args = array(
		...
		'title_reply' => '<h3 class="title-md hr-left mb-fourty">' . esc_html__( "Leave a reply", 'elixar' ) . '</h3>',
		 'comment_notes_after' => '', 
		'comment_field' => '<label>'. esc_html__( 'Message', 'elixar') .'<span class="e-default-colored">*</span></label><div class="row mb-twenty"><div class="col-md-11 col-md-offset-0"><textarea class="form-control" rows="8" name="comment" placeholder="' . esc_attr( 'Comment...', 'elixar' ) . '" id="comment"></textarea></div></div>',
