...
class Customizer_Tabs_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'tabs-control-script', get_template_directory_uri() . '/inc/customizer/custom-controls/customizer-tabs/js/script.js', array( 'jquery' ), '', true );
		wp_enqueue_style( 'tabs-control-style', get_template_directory_uri() . '/inc/customizer/custom-controls/customizer-tabs/css/style.css', null, '' );
