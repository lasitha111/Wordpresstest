...
function elixar_customize_register($wp_customize)
{
    ...
    require get_template_directory() . '/inc/customizer/custom-controls/customizer-controls.php';
    require get_template_directory() . '/inc/customizer/custom-controls/control-icon-picker/src/IconPicker.php';
    require get_template_directory() . '/inc/customizer/custom-controls/customizer-tabs/class/class-customizer-tabs-control.php';
    include dirname(__FILE__) . '/controls-in-tabs.php';

    add_filter('wptrt_icon_picker_url', function () {
        return get_template_directory_uri() . '/inc/customizer/custom-controls/control-icon-picker';
    });
    $wp_customize->register_control_type('\WPTRT\Customize\Control\IconPicker');
    $wp_customize->register_control_type('Elixar_Custom_Sortable_Control');
    /**
    ...
    $wp_customize->add_panel('elixar_home_sections_panel',
        array(
            'priority'       => 5,
            'capability'     => 'edit_theme_options',
            'theme_supports' => '',
            'title'          => esc_html__('Home Sections', 'elixar'),
            'description'    => '',
        )
    );
    /* Logo Settings
	...
	// Disable Home Page
    $wp_customize->add_setting('elixar_frontpage_enable',
        array(
            'sanitize_callback' => 'elixar_sanitize_checkbox',
            'default'           => 1,
        )
    );
    $wp_customize->add_control('elixar_frontpage_enable',
        array(
            'type'        => 'checkbox',
            'label'       => esc_html__('Show Home Page', 'elixar'),
            'section'     => 'elixar_global_settings',
            'description' => esc_html__('Check this box to show custom home page', 'elixar'),
        )
    );
    ...
    $wp_customize->add_control(new IconPicker(
        $wp_customize,
    ...
    /*------------------------------------------------------------------------*/
    // Hero settings
    $wp_customize->add_section('elixar_slider',
        array(
            'priority'    => 3,
            'title'       => esc_html__('Home Slider', 'elixar'),
            'description' => '',
            'panel'       => 'elixar_home_sections_panel',
        )
    );
    // Show section
    ...
    $wp_customize->add_section('elixar_cta',
        array(
            'priority'    => 3,
            'title'       => esc_html__('Home CallToAction', 'elixar'),
            'description' => '',
            'panel'       => 'elixar_home_sections_panel',
        )
    );
    ...
    /*  Section: Extra
    /*------------------------------------------------------------------------*/
    $wp_customize->add_section('elixar_extra',
        array(
            'priority'    => 3,
            'title'       => esc_html__('Home Extra', 'elixar'),
            'description' => '',
            'panel'       => 'elixar_home_sections_panel',
        )
    );
    ...
    /*  Section: Services
    /*------------------------------------------------------------------------*/
    $wp_customize->add_section('elixar_services',
        array(
            'priority'    => 3,
            'title'       => esc_html__('Home Services', 'elixar'),
            'description' => '',
            'panel'       => 'elixar_home_sections_panel',
        )
    );
    ...
    /*  Section: Blog
    /*------------------------------------------------------------------------*/
    $wp_customize->add_section('elixar_blog',
        array(
            'priority'    => 3,
            'title'       => esc_html__('Home Blog', 'elixar'),
            'description' => '',
            'panel'       => 'elixar_home_sections_panel',
        )
    );
    ...
    /*------------------------------------------------------------------------*/
    $wp_customize->add_section('elixar_reorder',
        array(
            'title'       => __('Home Page Re-order', 'elixar'),
            'description' => __('Here you can re-order your Home Page Section', 'elixar'),
            'priority'    => 160, // Before Additional CSS.
        )
    );

    $wp_customize->add_setting('elixar_home_reorder',
        array(
            'type'              => 'theme_mod',
            'sanitize_callback' => 'elixar_sanitize_json_string',
            'default'           => json_encode(array('service', 'callout', 'blog')),
        )
    );
    $wp_customize->add_control(new Elixar_Custom_Sortable_Control($wp_customize, 'elixar_home_reorder', array(
        'section' => 'elixar_reorder',
        'type'    => 'home-sortable',
        'choices' => apply_filters('elixar_customizer_frontpage_sections_order', array(
            'service'     => __('Home Service', 'elixar'),
            'callout'     => __('Home CTA', 'elixar'),
            'blog'        => __('Home Blog', 'elixar'),
            'extra'       => __('Home Extra', 'elixar'),
        )),
    )));
...
{
    wp_enqueue_script('elixar_customizer_livepreview', get_template_directory_uri() . '/inc/customizer/assets/js/elixar-customizer-livepreview.js', array('customize-preview', 'customize-selective-refresh'), false, true);
}
