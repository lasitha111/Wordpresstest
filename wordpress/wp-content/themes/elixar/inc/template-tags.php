...
if ( ! function_exists( 'elixar_get_section_services_data' ) ) {
    ...
    {
        $services = get_theme_mod('elixar_services', array(
			array(
				'icon_type' => 'icon',
		...
		//echo "<pre>"; print_r($elixar_page_ids);echo "</pre>";
...
if ( ! function_exists( 'elixar_custom_inline_style' ) ) {
	...
	function elixar_custom_inline_style( ) {
			...
			if ( !empty( $elixar_hero_page ) && $elixar_hero_page !=0 ) {
				...
				$elixar_hero_bgurl = get_template_directory_uri() . '/images/hero.jpg';
			}
			...
			if ( !empty($elixar_cta_page) && $elixar_cta_page!=0) {
				...
				$elixar_cta_bgurl = get_template_directory_uri() . '/images/cta.jpg';
			}
